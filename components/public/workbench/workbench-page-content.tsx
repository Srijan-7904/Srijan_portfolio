...
const wipItems = [
  {
    id: 1,
    name: "club20-website",
    description: "Club 20 LPU official website — leading development and digital infrastructure as Tech Lead",
    progress: 80,
  ...
  },
  {
    ...
    description: "AI-powered farming rover dashboard with IoT sensors, computer vision and real-time analytics",
    progress: 90,
  ...
  },
  {
    id: 3,
    name: "3d-portfolio",
    description: "3D interactive portfolio website built with React, Three.js, GSAP and Framer Motion",
    progress: 95,
  ...
  },
  {
    ...
    description: "Self-hosted monitoring stack with Prometheus, Grafana, and Kubernetes on cloud infrastructure",
    progress: 65,
  ...
  },
  {
    ...
    description: "Flask backend APIs with ML model integration for disease detection and IoT data aggregation",
    progress: 75,
    lastUpdated: "Jan 2026",
    url: "https://github.com/Srijan-7904",
    branch: "feature/ml-api",
    commits: 45,
  },
]

const recentActivity = [
  { type: "commit", project: "club20-website", message: "Add events section and responsive layout fixes", time: "1 hour ago" },
  { type: "branch", project: "devops-monitoring-stack", message: "Created develop branch for K8s configs", time: "3 hours ago" },
  { type: "commit", project: "smart-farming-system", message: "Integrate disease detection ML endpoint", time: "1 day ago" },
  { type: "commit", project: "3d-portfolio", message: "Polish animations and add skills section", time: "2 days ago" },
]
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-b border-border/50 bg-secondary/40 px-4 sm:px-5 py-3.5 sm:py-4">
                ...
                <span className="ml-4 font-mono text-xs text-muted-foreground truncate">~/Srijan-7904/active</span>
