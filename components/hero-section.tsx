...
const roles = ["building full-stack apps", "engineering DevOps solutions", "designing UI/UX", "writing clean code", "deploying cloud systems"]
          ...
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-3 animate-fade-in-up">
              <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">
                Srijan Jaiswal — Full Stack Developer & DevOps Engineer
              </p>
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              I am a driven and adaptable individual with a strong passion for continuous learning and self-improvement.
              I approach every challenge with enthusiasm and a commitment to excellence — currently studying at{" "}
