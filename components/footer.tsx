import { Github, Twitter, Linkedin, Instagram, ExternalLink, Heart } from "lucide-react"

const socialLinks = [
  { label: "GitHub", href: "https://github.com/Srijan-7904", handle: "@Srijan-7904", icon: Github },
  { label: "Twitter", href: "https://x.com/Srijanj7904", handle: "@Srijanj7904", icon: Twitter },
  { label: "LinkedIn", href: "https://linkedin.com/in/srijan-jaiswal-937477253", handle: "/in/srijan-jaiswal", icon: Linkedin },
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} Srijan Jaiswal — All rights reserved
          </p>
        </div>
      </div>
    </footer>
